set @d1 = str_to_date('2014-11-21 00', '%Y-%m-%d %H');
set @d2 = str_to_date('2014-12-01 00', '%Y-%m-%d %H');
set @d3 = str_to_date('2014-12-02 00', '%Y-%m-%d %H');

CREATE TABLE `u_11_21` (
